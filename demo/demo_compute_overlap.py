...
plt.subplot(312)
plt.title("positive reference: " + scan_paths[1] + " - overlap: " + str(overlap_pos) + "% - similarity: " + str(sim_pos))
plt.imshow(reference_range_list[1])
plt.subplot(313)
plt.title("negative reference: " + scan_paths[2] + " - overlap: " + str(overlap_neg) + "% - similarity: " + str(sim_neg))
